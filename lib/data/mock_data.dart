...
final List<Operacao> operacoesMock = [
  const Operacao(
      codOperacao: 1000, codTipoMv: 'C901', descOperacao: 'REMOLHO', status: 1),
  const Operacao(
      codOperacao: 1001,
      codTipoMv: 'C902',
...
final List<VariavelApontamento> variaveisMock = [
  ...
  const VariavelApontamento(
    ...
    codOperacao: 1000,
    seq: 1,
    descPrm: 'Volume de Água',
    descPadrao: '100% do Peso do Couro',
    descUnidade: 'Litros',
  ),
  const VariavelApontamento(
    id: 2,
    ...
    codOperacao: 1000,
    seq: 2,
    descPrm: 'Temperatura da Água',
    descPadrao: 'Faixa 50 a 70',
    descUnidade: 'ºC',
  ),
  const VariavelApontamento(
    id: 3,
  ...
  const VariavelApontamento(
    ...
    codOperacao: 1001,
    seq: 1,
    descPrm: 'Pressão do Rolo (1º manômetro)',
    descPadrao: '40 a 110',
    descUnidade: 'Bar',
  ),
  const VariavelApontamento(
    ...
    codOperacao: 1001,
    seq: 2,
    descPrm: 'Pressão do Rolo (2º manômetro)',
    descPadrao: '60 a 110',
    descUnidade: 'Bar',
  ),
  const VariavelApontamento(
  ...
  const VariavelApontamento(
    ...
    codOperacao: 1002,
    seq: 2,
    descPrm: 'Distância da Navalha',
    descPadrao: '8,0 a 8,5',
    descUnidade: 'mm',
  ),
  const VariavelApontamento(
    id: 10,
    ...
    codOperacao: 1002,
    seq: 3,
    descPrm: 'Fio da Navalha Inferior',
    descPadrao: '5,0 +/- 0,5',
    descUnidade: 'mm',
  ),
  const VariavelApontamento(
    ...
    codOperacao: 1002,
    seq: 4,
    descPrm: 'Fio da Navalha Superior',
    descPadrao: '6,0 +/- 0,5',
    descUnidade: 'mm',
  ),
];
